...
function applyStack(e, i, a, s = {}) {
  ...
  if (null !== i) {
    ...
    for (o = 0, l = n.length; o < l; ++o) {
      if ((h = +n[o]) === a) {
        if (((t = !0), s.all)) continue;
        break;
      }
      ((d = e.values[h]),
        isNumberFinite(d) && (r || 0 === i || sign(i) === sign(d)) && (i += d));
    }
    return t || s.all ? i : 0;
  }
}
function convertObjectDataToArray(t, e) {
  var { iScale: e, vScale: i } = e,
    a = "x" === e.axis ? "x" : "y",
    s = "x" === i.axis ? "x" : "y",
    n = Object.keys(t);
...
class DatasetController {
  ...
  _dataCheck() {
    ...
    if (isObject(e)) {
      ...
      this._data = convertObjectDataToArray(e, a);
    } else if (i !== e) {
      if (i) {
        unlistenArrayEvents(i, this);
        const s = this._cachedMeta;
        (clearStacks(s), (s._parsed = []));
      }
  ...
  buildOrUpdateElements(t) {
    ...
    ((e._stacked = isStacked(e.vScale, e)),
      ...
      (!a && s === e._stacked) ||
        (updateStacks(this, e._parsed), (e._stacked = isStacked(e.vScale, e))));
  }
  configure() {
  ...
  _getSharedOptions(t, e) {
    ...
    return (
      this.updateSharedOptions(a, e, t),
      { sharedOptions: a, includeOptions: i }
    );
  }
...
function parseValue(t, e, i, a) {
  return (
    isArray(t) ? parseFloatBar(t, e, i, a) : (e[i.axis] = i.parse(t, a)),
    e
  );
}
...
class BarController extends DatasetController {
  ...
  _getStacks(t, e) {
    ...
    var a = i
      ...
      s = i.options.stacked;
    const n = [];
    var r = this._cachedMeta.controller.getParsed(e);
    const o = r && r[i.axis];
    for (const l of a)
      if (
        (void 0 === e ||
          !((t) => {
            var e = t._parsed.find((t) => t[i.axis] === o),
              e = e && e[t.vScale.axis];
  ...
  _getAxis() {
    const t = {};
    var e = this.getFirstScaleIdForIndexAxis();
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    var a = this.options,
      s = a.skipNull,
      n = valueOrDefault(a.maxBarThickness, 1 / 0);
    let r, o;
    var l,
      h = this._getAxisCount();
    return (
      (o = e.grouped
        ? ((l = s ? this._getStackCount(t) : e.stackCount),
          (a = (
            "flex" === a.barThickness
          ...
          (h = this._getAxis().indexOf(
            valueOrDefault(l, this.getFirstScaleIdForIndexAxis())
          )),
          (l =
            this._getStackIndex(
              this.index,
          ...
          (r = a.start + a.chunk * l + a.chunk / 2),
          Math.min(n, a.chunk * a.ratio))
        : ((r = i.getPixelForValue(this.getParsed(t)[i.axis], t)),
          Math.min(n, e.min * e.ratio))),
      { base: r - o / 2, head: r + o / 2, center: r, size: o }
    );
  }
  draw() {
    var t = this._cachedMeta,
    ...
    let s = 0;
    for (; s < a; ++s)
      null === this.getParsed(s)[e.axis] || i[s].hidden || i[s].draw(this._ctx);
  }
}
    ...
    for (g = t; g < t + e; g++) {
      ...
      let t = u,
        ...
        i = r.getDataVisibility(g)
          ...
          : 0;
      ((u = e),
        n && (o.animateScale && (i = 0), o.animateRotate && (t = e = c)));
      var m = {
        x: h,
        y: d,
        innerRadius: 0,
...
function binarySearch(t, e, i, a) {
  var { controller: s, data: n, _sorted: r } = t,
    o = s._cachedMeta.iScale,
    l = t.dataset && t.dataset.options ? t.dataset.options.spanGaps : null;
  if (o && e === o.axis && "r" !== e && r && n.length) {
    const h = o._reversePixels ? _rlookupByKey : _lookupByKey;
    if (!a) {
      const d = h(n, e, i);
      if (l) {
        const c = s._cachedMeta["vScale"],
          u = t["_parsed"];
        ((r = u
          .slice(0, d.lo + 1)
          .reverse()
          .findIndex((t) => !isNullOrUndef(t[c.axis]))),
          (o =
            ((d.lo -= Math.max(0, r)),
            u.slice(d.hi).findIndex((t) => !isNullOrUndef(t[c.axis])))));
        d.hi += Math.max(0, o);
      }
      return d;
    }
    if (s._sharedOptions) {
      const g = n[0];
      a = "function" == typeof g.getRange && g.getRange(e);
      if (a)
        return (
          (l = h(n, e, i - a)),
          (t = h(n, e, i + a)),
  ...
  _computeLabelItems(t) {
    ...
    ("top" === a
      ...
      : "bottom" === a
        ...
        : "left" === a
          ? ((d = this._getYAxisLabelAlignment(i)),
            (_ = d.textAlign),
            (x = d.x))
          : "right" === a
            ? ((d = this._getYAxisLabelAlignment(i)),
    ...
    for (f = 0, m = o.length; f < m; ++f) {
          ...
          (M =
            "top" === a
              ? "near" === h || 0 != g
                ? -D * S + S / 2
                : "center" === h
                  ? -A.highest.height / 2 - w * S + S
                  : -A.highest.height + S / 2
              : "near" === h || 0 != g
                ? S / 2
                : "center" === h
                  ? A.highest.height / 2 - w * S
      ...
      if (C.showLabelBackdrop) {
        var w = toPadding(C.backdropPadding),
          I = A.heights[f],
          E = A.widths[f];
        let t = M - w.top,
          e = 0 - w.left;
...
class Chart {
  ...
  _drawDataset(t) {
    ...
    var a = getDatasetClipArea(this, t);
...
function clipSelf(t, e, i) {
  var {
    ...
    { borderWidth: o, borderJoinStyle: l } = o,
    h = Math.min(o / n, _normalizeAngle(e - i));
  (t.beginPath(),
    t.arc(a, s, n - o / 2, e + h / 2, i - h / 2),
    0 < r
      ? ((h = Math.min(o / r, _normalizeAngle(e - i))),
        t.arc(a, s, r + o / 2, i - h / 2, e + h / 2, !0))
      : ((r = Math.min(o / 2, n * _normalizeAngle(e - i))),
        "round" === l
          ? t.arc(a, s, r, i - PI / 2, e + PI / 2, !0)
          : "bevel" === l &&
            ((o = -(h = 2 * r * r) * Math.cos(i + PI / 2) + a),
            (n = -h * Math.sin(i + PI / 2) + s),
            (l = h * Math.cos(e + PI / 2) + a),
            (r = h * Math.sin(e + PI / 2) + s),
            t.lineTo(o, n),
            t.lineTo(l, r))),
    t.closePath(),
    t.moveTo(0, 0),
  ...
  if (d) {
    ...
    (f && clipArc(e, i, t),
      h.selfJoin &&
        ...
        "miter" !== c &&
        clipSelf(e, i, t),
      r || (pathArc(e, i, a, s, t, n), e.stroke()));
  }
}
class ArcElement extends Element {
  ...
  inRange(t, e, i) {
    var a = this.getProps(["x", "y"], i),
      ...
      a = _angleBetween(a, e, i) && e !== i,
      e = TAU <= r || a,
      i = _isBetween(t, s + o, n + o);
    return e && i;
  }
  getCenterPoint(t) {
    var {
...
var plugin_colors = {
  ...
  beforeLayout(t, e, i) {
    if (i.enabled) {
      ...
      (!i.forceOverride && a) || ((i = getColorizer(t)), s.forEach(i));
    }
  },
};
...
function _drawfill(t, e, i) {
  var a = _getTarget(e);
  const { chart: s, index: n, line: r, scale: o, axis: l } = e;
  var e = r.options,
    h = e.fill,
    e = e.backgroundColor,
    { above: h = e, below: e = e } = h || {},
    d = s.getDatasetMeta(n),
    d = getDatasetClipArea(s, d);
  a &&
    r.points.length &&
    (clipArea(t, i),
    doFill(t, {
  ...
  (n !== s &&
    ("x" === e
      ...
      : "y" === e &&
        ...
        t.restore(),
        t.save(),
        clipHorizontal(t, a, r.right),
        (h = s))),
    fill(t, { line: i, target: a, color: h, scale: o, property: e, clip: l }),
    t.restore());
}
...
function fill(e, t) {
  const { line: i, target: a, property: s, color: n, scale: r, clip: o } = t;
  var l, h, d, c;
  for ({ source: l, target: h, start: d, end: c } of _segments(i, a, s)) {
    var { style: { backgroundColor: u = n } = {} } = l,
      g = !0 !== a,
      u =
        (e.save(),
        (e.fillStyle = u),
        clipBounds(e, r, o, g && _getBounds(s, d, c)),
        e.beginPath(),
        !!i.pathSegment(e, l));
    let t;
    (g &&
      (u ? e.closePath() : interpolatedLineTo(e, a, c, s),
      (g = !!a.pathSegment(e, h, { move: u, reverse: !0 })),
      (t = u && g) || interpolatedLineTo(e, a, d, s)),
      e.closePath(),
      e.fill(t ? "evenodd" : "nonzero"),
      e.restore());
  }
}
function clipBounds(s, n, r, o) {
  var n = n.chart.chartArea,
    { property: o, start: l, end: h } = o || {};
  if ("x" === o || "y" === o) {
    let t, e, i, a;
    ((a =
      "x" === o
        ? ((t = l), (e = n.top), (i = h), n.bottom)
        : ((t = n.left), (e = l), (i = n.right), h)),
      s.beginPath(),
      r &&
        ((t = Math.max(t, r.left)),
        (i = Math.min(i, r.right)),
        (e = Math.max(e, r.top)),
        (a = Math.min(a, r.bottom))),
      s.rect(t, e, i - t, a - e),
      s.clip());
  }
}
    ...
    const { boxWidth: M, boxHeight: P, itemHeight: A } = getBoxSize(v, k),
      ...
      O =
        ((D = C
          ...
          : {
              x: this.left + y,
              y: _alignStartEnd(m, this.top + w + y, this.bottom - g[0].height),
              line: 0,
            }),
        ...
        isNaN(M) ||
          ...
          v.usePointStyle
            ...
            : ((o = h + Math.max((k - P) / 2, 0)),
              ...
              0 !== r && f.stroke()),
          f.restore()),
        (s = _textX(a, s + M + S, C ? s + i : this.right, u.rtl)),
        (h = b.x(s)),
        (e = n),
        (d = t),
...
const positioners = {
  average(t) {
    ...
    for (e = 0, i = t.length; e < i; ++e) {
      ...
      o &&
        o.hasValue() &&
        ((r = o.tooltipPosition()), a.add(r.x), (s += r.y), ++n);
    }
    return (
      0 !== n &&
      0 !== a.size && { x: [...a].reduce((t, e) => t + e) / a.size, y: s / n }
    );
  },
  nearest(t, e) {
    if (!t.length) return !1;
    ...
    var h;
    return (
      o && ((h = o.tooltipPosition()), (i = h.x), (a = h.y)),
      { x: i, y: a }
    );
  },
};
...
class Tooltip extends Element {
  ...
  getTitle(t, e) {
    ...
    return (
      (t = pushOrConcat(t, splitNewlines(a))),
